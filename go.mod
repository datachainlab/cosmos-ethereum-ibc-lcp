...
require (
	...
	github.com/datachainlab/ethereum-light-client-types v0.1.0-rc4 // indirect
...
replace github.com/datachainlab/ethereum-ibc-relay-prover => github.com/yoshidan/ethereum-ibc-relay-prover v0.4.0-rc3
